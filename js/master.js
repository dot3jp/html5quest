...
var Serif = {
	...
	battleBoss:{
		start:[
			   "まおう「きさまは&nbsp;わたしを&nbsp;おこらせた・・」", 
			   "まおう「このせかいを　きょうふ　と　あんこく　で　そめ", 
			   "__braveName__「おのれ&nbsp;ゆるさん！！」"
			   ], 
		end:[
			 "まおう「ぐああああ」", 
			 "まおう「こ、このわたしが」", 
			 ...
			 "ズゴゴゴゴゴゴ", 
			 "",
			 "__braveName__「た、たおした・・」", 
			 "",
			 "__braveName__「ところで」",
			 "__braveName__「こいつら　だれだったんだろう」"
			 ]
		}
...
Battle.prototype =
{
	...
	{
		$("#wrapper").append('<section id="help"><h2>へるぴ　がめん</h2><a href="javascript:void(0);" id="help_x" class="bx">Xとじる</a><article id="help_img" class="bx"><p><img src="img/tutorial.jpg" alt="ローカルの画像を「コマンド」枠にいれてね" width="380" height="266"/></p><p id="help_ttl">-&nbsp;あそびかた&nbsp;-</p></article></section>')
